...
-H "Authorization: Bearer JC9QgwQrHMW8IIbzeK06QxpYmnHCmNfGnzzimgcpI/ASLYEKx0REduc60G1VFIvu/z/JjaDGU8xGollYFtpm+c9yfTwA29AwVzLs7Rf8V4dkjPKyIvHXdpU9ILEn/MabXzJ/9EtBtYu78tBhsBxqPgdB04t89/1O/w1cDnyilFU=" -d ""';
...
let richmenuType = {
    beforeBinding: function(lineId) {
        return 'curl -v -X POST https://api.line.me/v2/bot/user/' + lineId + '/richmenu/richmenu-56fe6a2850a8e1f0b03439c468cf8dfc \
        -H "Authorization: Bearer JC9QgwQrHMW8IIbzeK06QxpYmnHCmNfGnzzimgcpI/ASLYEKx0REduc60G1VFIvu/z/JjaDGU8xGollYFtpm+c9yfTwA29AwVzLs7Rf8V4dkjPKyIvHXdpU9ILEn/MabXzJ/9EtBtYu78tBhsBxqPgdB04t89/1O/w1cDnyilFU=" -d ""'
    },
    afterBinding: function(lineId) {
        return 'curl -v -X POST https://api.line.me/v2/bot/user/' + lineId + '/richmenu/richmenu-460f6302b2b4bb03012a7875f572db1d \
    -H "Authorization: Bearer JC9QgwQrHMW8IIbzeK06QxpYmnHCmNfGnzzimgcpI/ASLYEKx0REduc60G1VFIvu/z/JjaDGU8xGollYFtpm+c9yfTwA29AwVzLs7Rf8V4dkjPKyIvHXdpU9ILEn/MabXzJ/9EtBtYu78tBhsBxqPgdB04t89/1O/w1cDnyilFU=" -d ""'
    }
}
