...
let logFactory = require('./logFactory');
...
let richmenuType = {
    beforeBinding: function(lineId) {
        return 'curl -v -X POST https://api.line.me/v2/bot/user/' + lineId + '/richmenu/richmenu-045d8521e7145722379d9de15f6be215 \
        -H "Authorization: Bearer gxS3/xEi58GEq7dF+m1Fw47WRw+Jmwm+lXfd9Z/dBJVET3mmfJu5mdF6mPYpH4D6frASHurqDUEsWkg6SXaJSuvf3BmoBIV0yMVfyZior38v7zlyV4Gnqqp0lIaoB545Q0l2Bx28bX1M0CaXNNZDfwdB04t89/1O/w1cDnyilFU=" -d ""'
    },
    afterBinding: function(lineId) {
        return 'curl -v -X POST https://api.line.me/v2/bot/user/' + lineId + '/richmenu/richmenu-70099967387ac62058de8608e18dd06e \
    -H "Authorization: Bearer gxS3/xEi58GEq7dF+m1Fw47WRw+Jmwm+lXfd9Z/dBJVET3mmfJu5mdF6mPYpH4D6frASHurqDUEsWkg6SXaJSuvf3BmoBIV0yMVfyZior38v7zlyV4Gnqqp0lIaoB545Q0l2Bx28bX1M0CaXNNZDfwdB04t89/1O/w1cDnyilFU=" -d ""'
    }
}
